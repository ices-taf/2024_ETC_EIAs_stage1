...
# read in data
file <- taf.data.path("Linkage_Framework_Stage_1-fisheries.xlsx")
...
saveRDS(secPress, "data/fisheries_secPress.RDS")
saveRDS(pressEcoChar, "data/fisheries_pressEcoChar.RDS")
